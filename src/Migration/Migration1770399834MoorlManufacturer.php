...
ALTER TABLE moorl_manufacturer ADD CONSTRAINT `fk.moorl_manufacturer.moorl_marker_id` FOREIGN KEY (moorl_marker_id) REFERENCES moorl_marker (id) ON UPDATE CASCADE ON DELETE SET NULL;
